...
t & \textbf{t}hreshold\\
n & Größe der Eingabemengen\\
N & Anzahl der teilnehmenden Parteien\\
...
%% ----------------------------------------------------------------
\lhead{\emph{Liste von Darstellungen}}  % Set the left side page header to "List if Figures"
\listoffigures  % Write out the List of Figures

%% ----------------------------------------------------------------
\lhead{\emph{Liste von Tabellen}}  % Set the left side page header to "List of Tables"
